    ...
    $faq_array = [
        ...
        [
            ...
            'answers' => [
                ...
                '<ol><li>La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:<ol class="list-caracter"><li>Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell\'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.</li><li>Google LLC, con sede negli Stati Uniti, per il resto del mondo.</li></ol></li><li>La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali.</li></ol>',
    ...
    <header>
        ...
        <div class="header-top">
            ...
            <div class="header-logo">
                ...
                <img src="https://cdn.freebiesupply.com/images/large/2x/google-logo-transparent.png" alt="Img Google">
                </div>
                <!-- Header logo text -->
    ...
    <main>
        ...
        <div class="container">
            ...
            <div class="main-content">
                <?php foreach($faq_array as $question_and_answer) { ?>
                    <section>
                        <h2><?php echo $question_and_answer['question']; ?></h2>
                        <?php foreach($question_and_answer['answers'] as $single_answer) { ?>
                            <div>
                                <?php echo $single_answer; ?>
                            </div>
                        <?php }; ?>
                    </section>
                <?php };?>
